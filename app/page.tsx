...
const TOOLS: Tool[] = [
  ...
  { id: 'diskcleanup', label: 'Windows Disk Cleanup', href: 'https://support.microsoft.com/en-us/windows/disk-cleanup-in-windows-8a96ff42-5751-39ad-23d6-4349818186ca', description: 'Built-in Windows utility to free up disk space by removing temporary files, system files, and other unnecessary data. Run with administrator privileges for full access. A better alternative to CCleaner.', icon: '🗑️', tags: ['built-in', 'system-cleaner', 'disk-space', 'optimization'], category: 'Maintenance', section: 'Essential Apps' },
